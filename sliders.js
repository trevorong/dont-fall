...
cWSlider.oninput = function() {
  climber_label.innerHTML = "Climber Weight: "+this.value+" lbs";
}
...
bWSlider.oninput = function() {
  belayer_label.innerHTML = "Belayer Weight: "+this.value+" lbs";
}
...
cHSlider.oninput = function() {
  climber_height_label.innerHTML = "Climber Height: "+this.value+" meters";
}
...
pHSlider.oninput = function() {
  pulley_label.innerHTML = "Pulley/Quickdraw Height: "+this.value+" meters";
}